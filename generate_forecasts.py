...
from predictor import predict_next_weeks, predict_product_sales, prepare_category_df, prepare_product_df
...
def generate_category_forecasts():
    ...
    # Guardar solo el array, el endpoint envolverá con la clave correcta
